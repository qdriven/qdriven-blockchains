...
public class CompoundLiquidator {
    ...
    private ContractInvoker createInvoker(CompoundCalculator.LiqTransactionInfo tx) {
    ...
    private TransactionReceipt cerc20LiquidateBorrow(CompoundCalculator.LiqTransactionInfo tx) throws Exception {
    ...
    private TransactionReceipt cethLiquidateBorrow(CompoundCalculator.LiqTransactionInfo tx) throws Exception {
...
//    TransactionReceipt txReceipt = receiptProcessor.waitForTransactionReceipt(txHash);
    ...
    public void liquidateBorrow(CompoundCalculator.LiqTransactionInfo tx) {

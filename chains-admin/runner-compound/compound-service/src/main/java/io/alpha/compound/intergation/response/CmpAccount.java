 ...
 * }
 */
public class CmpAccount implements Comparable<CmpAccount> {
    private String address;
    private CompoundValue health;
    private List<AccountCToken> tokens;
    private CompoundValue total_borrow_value_in_eth;
    private CompoundValue total_collateral_value_in_eth;

    @Override
    public int compareTo(CmpAccount o) {
        if (o.health != null && this.health != null) {

package io.alpha.compound.contracts.ctoken;
...
public class CERC20Contract extends Contract {
    ...
    @Deprecated
    protected CERC20Contract(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected CERC20Contract(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected CERC20Contract(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected CERC20Contract(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public RemoteFunctionCall<TransactionReceipt> _setComptroller(String newComptroller) {
        final Function function = new Function(
                ...
                Arrays.<Type>asList(new Address(160, newComptroller)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<BigInteger> initialExchangeRateMantissa() {
    ...
    public RemoteFunctionCall<TransactionReceipt> liquidateBorrow(String borrower,
                                                                  BigInteger repayAmount,
    ...
    public List<NewComptrollerEventResponse> getNewComptrollerEvents(TransactionReceipt transactionReceipt) {
        List<EventValuesWithLog> valueList = extractEventParametersWithLog(NEWCOMPTROLLER_EVENT, transactionReceipt);
    ...
    public Flowable<NewComptrollerEventResponse> newComptrollerEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new io.reactivex.functions.Function<Log, NewComptrollerEventResponse>() {
            ...
            public NewComptrollerEventResponse apply(Log log) {
                EventValuesWithLog eventValues = extractEventParametersWithLog(NEWCOMPTROLLER_EVENT, log);
                NewComptrollerEventResponse typedResponse = new NewComptrollerEventResponse();
                typedResponse.log = log;
                typedResponse.oldComptroller = (String) eventValues.getNonIndexedValues().get(0).getValue();
                typedResponse.newComptroller = (String) eventValues.getNonIndexedValues().get(1).getValue();
    ...
    @Deprecated
    public static CERC20Contract load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new CERC20Contract(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static CERC20Contract load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new CERC20Contract(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static CERC20Contract load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new CERC20Contract(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static CERC20Contract load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new CERC20Contract(contractAddress, web3j, transactionManager, contractGasProvider);
    }

...
public class Wad18 extends NumberWrapper {
    ...
    @Override
    public Wad18 divide(BigInteger divisorWrapper) {
        return this.divide(new Wad18(divisorWrapper));
    }

    @Override
    public Wad18 divide(NumberWrapper divisorWrapper) {
    ...
    @Override
    public Wad18 multiply(NumberWrapper multiplicandNumberWrapper) {
    ...
    public Wad18 multiply(Wad18 multiplicand) {
        return new Wad18(
                bigDecimal
    ...
    @Override
    public Wad18 add(NumberWrapper augend) {
        return new Wad18(bigDecimal.add(augend.toBigDecimal()));
    }

    @Override
    public Wad18 subtract(NumberWrapper subtrahend) {
        return new Wad18(bigDecimal.subtract(subtrahend.toBigDecimal()));
    }

    @Override
    public Wad18 min(NumberWrapper compareObject) {
        return new Wad18(bigDecimal.min(compareObject.toBigDecimal()));
    }

    @Override
    public Wad18 max(NumberWrapper compareObject) {

...
public class NumberWrapper implements Comparable<NumberWrapper> {
    ...
    public NumberWrapper divide(BigInteger divisorWrapper) {
        return this.divide(new Wad18(divisorWrapper));
    }

    public NumberWrapper divide(NumberWrapper divisorWrapper) {
    ...
    public NumberWrapper multiply(NumberWrapper multiplicand) {
    ...
    public NumberWrapper add(NumberWrapper augend) {
        return new Wad18(bigDecimal.add(augend.toBigDecimal()));
    }

    public NumberWrapper subtract(NumberWrapper subtrahend) {
        return new Wad18(bigDecimal.subtract(subtrahend.toBigDecimal()));
    }

    @Override
    public int compareTo(NumberWrapper val) {
    ...
    public NumberWrapper min(NumberWrapper compareObject) {
        return new NumberWrapper(bigDecimal.min(compareObject.toBigDecimal()), this.decimals);
    }

    public NumberWrapper max(NumberWrapper compareObject) {
